            ...
            <div className="container my-5">
                <div className="row justify-content-center align-items-start">
                    <div className="col-md-6 col-lg-4 mb-4 d-flex">
                        <div className="p-4 d-flex flex-column" style={{ backgroundColor: "white", borderRadius: "10px", border: "2px solid #F4512C", width: '100%', minHeight: '250px' }}>
                            ...
                            <form className="d-flex flex-column mb-3" onSubmit={handleSubmit}>
                                <input className="form-control me-2 mb-2" placeholder="Add an item" name="task" style={{ border: "1px solid #D3D3D3", width: '100%' }} />
                                <DatePicker
                                    selected={dueDate}
                                ...
                                <button className="btn btn-primary" type="submit" style={{ background: "linear-gradient(90deg, #5E1B89, #F4512C)", border: "#F4512C" }}>
                                    Add
                                </button>
                            </form>
                        </div>
                    ...
                    <div className="col-md-6 col-lg-8 mb-4 d-flex">
                        <div className="p-4 d-flex flex-column justify-content-center align-items-center" style={{ background: "linear-gradient(360deg, #FF4500, #8B008B)", borderRadius: "10px", border: "2px solid #F4512C", textAlign: "center", width: '100%', minHeight: '250px' }}>
